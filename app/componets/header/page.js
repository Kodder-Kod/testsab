...
import { FaUser, FaTerminal, FaClock, FaMoneyBillWave, FaReceipt, FaFileInvoiceDollar, FaExclamationCircle, FaCookieBite } from "react-icons/fa";
...
import Orders from "@/app/allpages/order/page";
import Expenses from "@/app/allpages/expenses/page";
import { useUserOrders, useUserOrdersData, useUserOrdersTotal } from "../zustand/orders";
...
const Header = () => {
    ...
    const rolePages = {
        Admin: ["Dashboard", "Orders", "Inventory", "Receipts", "Debt", "Expenses", "Reports", "Suppliers", "Settings"],
        Manager: ["Inventory", "Orders", "Receipts", "Debt", "Reports", "Expenses", "Suppliers", "Profile"],
        Cashier: ["Dashboard", "Orders", "Receipts", "Debt", "Profile"],
    };
