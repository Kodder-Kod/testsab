            ...
            {!receiptModal && (
                <div className="flex flex-col lg:flex-row flex-grow p-1">
                        ...
                        <div className="space-y-2 flex-1 overflow-y-auto">
                            {employees && employees.map((employees, index) => (
                                <button
                                    ...
                                    className={`w-full flex justify-between items-center p-1 py-3 rounded shadow-lg text-sm sm:text-base
                                  ${theme === "Dark"
                    ...
                    <aside className="w-full lg:w-2/4 p-6 border-r shadow-md rounded-lg h-auto sm:h-screen flex flex-col">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-sm sm:text-lg font-bold mr-20 ">Customer Name</h3>
                        </div>
  ...
  "
                        >
                            ...
                            {filteredTickets && [...filteredTickets]
                                ...
                                .map((ticket, index) => (
                                    ...
                                    <button
                                        ...
                                        onClick={() => handleTicketClick(ticket.id, ticket.Cart, ticket.EmployeeID, ticket.CashSale, ticket.Date)}
                                ...
                                ${theme === "Dark"
                                    ...
                                    >
                                        <p className=" text-xs sm:text-sm ">
                                            {ticket.Name} ~ {new Date(ticket.Date).toLocaleString("en-GB")}
                                        </p>
                            ...
                            {!filteredTickets &&
                                <div>
                                    <div className=" justify-center flex sm:mt-20">
                                        <FaExclamationCircle className={` text-md sm:text-4xl 
                                       ${theme === "Dark"
                                                ? " text-white"
                                                : " text-black "
                                            }`
                    ...
                    <section className="w-full h-screen flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto ">
                            ...
                            <div className="mt-4 font-bold text-md sm:text-lg mx-20">
                                Total: Ksh {total.toFixed(2)}
                            </div>
                            {cart1 &&
                                <div className="flex justify-end">
                                    <button
                                        className={`py-2 px-7 mt-4 rounded-lg mx-5 text-xs sm:text-base
      ${theme === "Dark"
